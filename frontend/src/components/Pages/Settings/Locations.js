...
function Locations() {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_URL}/admin/location-view?page=${pageNumber + 1}&page_size=${pageSize}&search=${searchTerm}`, {
            headers: {
    ...
    function confirmAddData(event) {
        ...
        if (['jpg', 'jpeg', 'png'].includes(fileExtension)) {
            setFormData({
                name: event.target.elements.location_name.value,
                image: image,
    ...
    function handleAddData() {
        axios.post(`${process.env.REACT_APP_API_URL}/admin/location-create`, formData, {
            headers: {
    ...
    function handleEditData() {
        axios.put(`${process.env.REACT_APP_API_URL}/admin/location-update/${update_id}`, formData, {
            headers: {
    ...
    function handleDeleteData(id) {
        fetch(`${process.env.REACT_APP_API_URL}/admin/location-delete/${id}`, {
    ...
    function handleCommunity(id, name) {
        const location_name = encodeURIComponent(`${name}`);
        navigate(`/settings/locations/communities/${id}/${location_name}`);
    }
    ...
    return (
        <>
            <h3 className="text-white mb-3 mt-3 mx-4 bg-gradient-primary pt-4 pb-4 px-4 rounded-2">Locations</h3>
            <div className="card shadow border-primary mb-3 mx-4">
                <div className="card-header">
                    <p className="text-primary m-0 fw-bold d-inline">Location's Information</p>
                ...
                <div className="card-body rounded-3">
                    <div className="row g-3">
                        <div className='col-md-11'>
                            <input type="text" className="form-control" placeholder="Search Location Name!"
                                   aria-label="Search"
                                    ...
                                    <tr key={data.id}>
                                        ...
                                        <td>
                                            <button className="btn btn-primary btn-sm mx-1"
                                                    onClick={() => handleCommunity(data.id, data.name)}>
                                                Communities
                                            </button>
                                        </td>
                                        <td>
            ...
            >
                ...
                <Modal.Body>
                    <form onSubmit={confirmAddData} encType="multipart/form-data">
                        ...
                        <input className="form-control" type="text" name="location_name" id="location_name"
