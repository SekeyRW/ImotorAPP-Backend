...
function Trim() {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_URL}/admin/trim-view/${id}?page=${pageNumber + 1}&page_size=${pageSize}&search=${searchTerm}`, {
            headers: {
    ...
    function handleAddData() {
        axios.post(`${process.env.REACT_APP_API_URL}/admin/trim-create/${id}`, formData, {
            headers: {
    ...
    function handleEditData() {
        axios.put(`${process.env.REACT_APP_API_URL}/admin/trim-update/${update_id}`, formData, {
            headers: {
    ...
    function handleDeleteData(id) {
        fetch(`${process.env.REACT_APP_API_URL}/admin/trim-delete/${id}`, {
            ...
            .then(response => {
                ...
                setData(updatedData);
                toast.success('Trim removed successfully.');
            })
            .catch(error => {
                console.error(error);
         ...
         <>
            ...
            <div className="card shadow border-primary mb-3 mx-4">
                <div className="card-header">
                    <p className="text-primary m-0 fw-bold d-inline">Trim Information</p>
                ...
                <div className="card-body rounded-3">
                    <div className="row g-3">
                        <div className='col-md-11'>
                            <input type="text" className="form-control" placeholder="Search Trim Name!"
                                   aria-label="Search"
            ...
            >
                ...
                <Modal.Body>
                    <form onSubmit={confirmAddData}>
                        <label className="form-label">Trim Name</label>
            ...
            <Modal show={showAddConfrimModal} onHide={() => setAddConfirmModal(false)} backdrop='static'>
                <Modal.Header>
                    <Modal.Title>Confirm Trim Details</Modal.Title>
                </Modal.Header>
                <Modal.Body>
            ...
            <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)} backdrop='static'>
                <Modal.Header>
                    <Modal.Title>Delete Trim</Modal.Title>
                </Modal.Header>
                <Modal.Body>
