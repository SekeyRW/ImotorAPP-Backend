...
function CarListings() {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_API_URL}/admin/car-listing-view?page=${pageNumber + 1}&page_size=${pageSize}&search=${searchTerm}&status=${status}`, {
            headers: {
    ...
    return (
        <>
            <h3 className="text-white mb-3 mt-3 mx-4 bg-gradient-primary pt-4 pb-4 px-4 rounded-2">Car Listings</h3>
            <div className="card shadow border-primary mb-3 mx-4">
                <div className="card-header">
                    <p className="text-primary m-0 fw-bold d-inline">Car's Information</p>
                </div>
